...
public class App {
  ...
  public static void main(String[] args) {
    ...
    com.shrralis.chain.OrcKing king = new com.shrralis.chain.OrcKing();
    king.makeRequest(new Request(com.shrralis.chain.RequestType.DEFEND_CASTLE, "defend castle"));
    king.makeRequest(new Request(com.shrralis.chain.RequestType.TORTURE_PRISONER, "torture prisoner"));
    king.makeRequest(new Request(com.shrralis.chain.RequestType.COLLECT_TAX, "collect tax"));
